    ...
    >
      ...
      <div>
        ...
        <Input
          ...
          type="email"
          {...register("email")}
          className="border-blue-200 focus:ring-blue-500 py-6"
        />
        {errors.email && (
      ...
      <div className="relative">
        ...
        <Input
          ...
          {...register("password")}
          className="border-blue-200 focus:ring-blue-500 pr-10 py-6"
        />
        <button
          type="button"
      ...
      <Button
        ...
        className="w-full bg-blue-600 hover:bg-blue-800 focus:ring-blue-500 py-6"
      >
