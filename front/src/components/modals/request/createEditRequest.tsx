      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            {errors.vehicleId && (
              <p className="text-gray-400">Vehicle selection is required</p>
            )}
          </div>
          <div>
            ...
            />
            {errors.checkIn && (
              <p className="text-gray-400">Check In time is required</p>
            )}
          </div>
          <div>
            ...
            />
            {errors.checkOut && (
              <p className="text-gray-400">Check Out time is required</p>
            )}
          </div>
          <DialogFooter>
