...
function DataTable<T>({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <div className="overflow-x-auto rounded-lg shadow-md border border-gray-100 bg-[#D4DEE1]">
        <table className="min-w-full divide-y divide-[#D4DEE1] text-sm text-gray-800 bg-[#D4DEE1]">
